...
class GuiMaker(Frame):
    ...
    def __init__(self,parent=None):
        ...
        #self.parent=parent
        #self.guiNum=guiNum
        #self.parent.title(guiName+str(guiNum))
    ...
    def makeWidgets(self):
        name = Label(self, width=40, height=10, relief=SUNKEN, bg='white', text = self.__class__.__name__,
                     cursor= 'crosshair')
    ...
    def makeMenuBar(self):
        ...
        if self.helpbutton:
            if sys.platform[:3] == 'win':
                ...
                menubar.add_cascade(label='Help', men=pulldown)
